...
namespace SFA.DAS.Assessor.Functions.UnitTests.RefreshIlrs.Services.RefreshIlrsLearner
{
    ...
    {
        protected RefreshIlrsLearnerService Sut;

        protected Mock<IOptions<RefreshIlrsSettings>> Options;
        ...
        protected Mock<ILogger<RefreshIlrsLearnerService>> Logger;
        ...
        {
            Options = new Mock<IOptions<RefreshIlrsSettings>>();
            Options.Setup(p => p.Value).Returns(new RefreshIlrsSettings
            {
                ProviderPageSize = 1,
            ...
            Sut = new RefreshIlrsLearnerService(Options.Object, DataCollectionServiceApiClient.Object, AssessorServiceApiClient.Object, Logger.Object);
        }
