        ...
        public void Arrange()
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                _mockExternalFileTransferClient
                    ...
                    { DeliveryNotifications = new List<Domain.Print.Types.Notifications.DeliveryNotification>
                        { new Domain.Print.Types.Notifications.DeliveryNotification { BatchID = _batchNumber } } }));
            };
